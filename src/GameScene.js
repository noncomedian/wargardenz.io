    ...
    return (hours == "00"?"": hours+"h ") + (minutes == "00"?"": minutes+"m ") + seconds+"s";
          ...
          this.scene.start("title");
            ...
            if(this.spectating) return;
				...
				//go packet
				var server = this.options.server == "eu1" ? "wss://wargardenz.herokuapp.com" : this.options.server == "us2" ? "wss://wargardenz-us2.herokuapp.com" : "wss://sword-io-game.herokuapp.com";
